...
<div class="bg-[#202124] rounded-xl">
  <div class="container mx-auto px-4" style="font-family: Arial, sans-serif;">
    <div class="py-2">
        <div class="relative">
            <button class="btn btn-sm absolute top-0 right-0 bg-none rounded-md px-0 py-0" use:popup={GoogleInfo} ><InfoIcon classes="hover:text-secondary-300 transition" /></button>
        </div>
